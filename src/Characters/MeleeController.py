...
class MeleeController(Controller):
	"""
	...
	def check_melee_hit(self):
		...
		"""
		return self.player.can_attack() and self.player.is_attacking() and self.collides_with_player() and self.player.has_melee_weapon()
